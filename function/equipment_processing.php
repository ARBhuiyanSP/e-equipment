...
if (isset($_POST['rrr_create_draft']) && !empty($_POST['rrr_create_draft'])){
    ...
    if(isset($rrr_info_response) && $rrr_info_response['status'] == "success"){
        ...
        */    
        //$rrr_details_response  =   execute_equipment_details_table($rrr_info_id);
        ...
        process_equipment_acknowledgement($ackParam);
...
function execute_equipment_details_table($rrr_info_id){
    global $conn;
    /*
     * *****************************rrr_details table operation********************
     */
...
function getEquipmentDetailsData($rrr_id){
