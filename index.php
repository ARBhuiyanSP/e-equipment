...
<html>
    <head>
        ...
        <title>Equipment Management System | Log in</title>
    ...
    <body class="login-block">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 login-sec">
                        <h2 class="text-center">Equipment Management Login</h2>
        ...
        <div class="development_credit">Designed & Developed by SAIF POWERTEC</div>
